...
export const linkShortcuts: UserShortcuts = [
  [
    'ui-link-base',
    'relative inline-flex w-fit items-center [text-decoration:none] [transition:color_var(--motion-underline-duration)_var(--motion-underline-ease)] focus-visible:outline-none',
  ],
  [
