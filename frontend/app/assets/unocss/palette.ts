...
const bgTokens: TokenSet = {
  ...
  'bg-quaternary-focus': { light: 'var(--un-preset-radix-sand5)', dark: 'var(--un-preset-radix-sand6)' },
...
const ringTokens: TokenSet = {
  ...
  'ring-quaternary-focus': { light: 'var(--un-preset-radix-sand5)', dark: 'var(--un-preset-radix-sand6)' },
