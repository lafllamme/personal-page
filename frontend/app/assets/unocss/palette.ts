...
const colorTokens: TokenSet = {
  ...
  'color-accent-quaternary-disabled': { light: '#90a19e', dark: 'rgba(173, 240, 221, 0.45)' },
}
...
const backgroundTokens: TokenSet = {
  ...
  'background-overlay-hover': { light: 'rgba(0, 0, 0, 0.08)', dark: 'rgba(242, 239, 230, 0.08)' },
  'background-overlay-active': { light: 'rgba(0, 0, 0, 0.14)', dark: 'rgba(242, 239, 230, 0.14)' },

  'background-quaternary': { light: 'rgba(0, 0, 0, 0.06)', dark: 'rgba(242, 239, 230, 0.06)' },
  'background-quaternary-hover': { light: 'rgba(0, 0, 0, 0.12)', dark: 'rgba(242, 239, 230, 0.12)' },
  'background-quaternary-active': { light: 'rgba(0, 0, 0, 0.18)', dark: 'rgba(242, 239, 230, 0.18)' },
  'background-quaternary-disabled': { light: 'rgba(0, 0, 0, 0.04)', dark: 'rgba(242, 239, 230, 0.04)' },
...
export const themeColors = {
  ...
  background: createTokenVarMap(backgroundTokens),
