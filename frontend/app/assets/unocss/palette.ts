...
const colorTokens: TokenSet = {
  ...
  'color-badge-default-crisp-text': { light: 'var(--un-preset-radix-sand12)', dark: 'var(--un-preset-radix-sand12)' },
  'color-badge-mixed-crisp-text': { light: 'var(--un-preset-radix-sand12)', dark: 'var(--un-preset-radix-sand12)' },
  ...
  'color-badge-shimmer-highlight': { light: 'color-mix(in srgb, var(--un-preset-radix-sand12) 14%, transparent)', dark: 'var(--un-preset-radix-sand2)' },
...
const bgTokens: TokenSet = {
  ...
  'bg-badge-default-crisp': { light: 'var(--un-preset-radix-sand2)', dark: 'var(--un-preset-radix-sand2)' },
  'bg-badge-mixed-crisp': { light: 'var(--un-preset-radix-sand2)', dark: 'var(--un-preset-radix-sand2)' },
...
const borderTokens: TokenSet = {
  ...
  'border-badge-default-crisp': { light: 'var(--un-preset-radix-sand8)', dark: 'var(--un-preset-radix-sand10)' },
  'border-badge-mixed-crisp': { light: 'var(--toxic-8)', dark: 'var(--toxic-10)' },
  'border-badge-accent-soft': { light: 'var(--toxic-7)', dark: 'var(--toxic-8)' },
  'border-badge-accent-crisp': { light: 'var(--toxic-10)', dark: 'var(--toxic-7)' },
...
const motionTokens: TokenSet = {
  ...
  'motion-badge-shimmer-duration': '5.8s',
...
const sizingTokens: TokenSet = {
  ...
  'size-badge-height-sm': '1.5rem',
  'size-badge-height-md': '1.625rem',
  'size-badge-height-lg': 'calc(var(--space-6) + var(--space-1_5))',
  'size-badge-height-xl': 'calc(var(--space-8) + var(--space-0_5))',
  'size-badge-dot-sm': '0.375rem',
  'size-badge-dot-md': '0.4375rem',
  'size-badge-dot-lg': 'var(--space-2)',
  'size-badge-dot-xl': 'var(--space-2_5)',
  ...
  'radius-badge-beam-inner-offset': 'var(--space-0_25)',
  'radius-3xl': '1.5rem',
  'radius-4xl': '2rem',
  'radius-pill': '9999px',
  ...
  'size-badge-beam-ring-width': 'var(--space-0_25)',
  'size-badge-beam-orbit-overscan': '1000%',
}
