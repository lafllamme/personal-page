...
const colorTokens: TokenSet = {
  ...
  'color-accent-ui': { light: '#145750', dark: 'var(--toxic-11)' },
...
const bgTokens: TokenSet = {
  ...
  'bg-accent': { light: 'var(--toxic-12)', dark: 'var(--toxic-11)' },
  'bg-accent-hover': { light: 'var(--toxic-11)', dark: 'var(--toxic-10)' },
...
const borderTokens: TokenSet = {
  ...
  'border-accent': { light: 'var(--toxic-12)', dark: 'var(--toxic-11)' },
  'border-accent-ui': { light: '#145750', dark: 'var(--toxic-11)' },
