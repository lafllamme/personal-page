...
export const typographyShortcuts: UserShortcuts = [
  ...
  ['type-meta-lg', 'font-meta type-size-lg tracking-$type-track-meta-lg'],
  ['type-meta-xl', 'font-meta type-size-xl tracking-$type-track-meta-xl'],
  ['type-meta-2xl', 'font-meta type-size-2xl tracking-$type-track-meta-2xl'],
