...
export const variantShortcuts: UserShortcuts = [
  [
    'v-neutral-solid',
    'bg-$bg-solid border-transparent color-$color-inverse [box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-primary)] hover:enabled:[box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-primary),0_0_0_var(--focus-ring-inner-width)_var(--ring-primary-offset-inner),0_0_0_var(--focus-ring-outer-width)_var(--ring-primary-offset-outer)] focus-visible:[box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-primary),0_0_0_var(--focus-ring-inner-width)_var(--ring-primary-offset-inner),0_0_0_var(--focus-ring-outer-width)_var(--ring-primary-offset-outer)] active:enabled:translate-y-[1px] active:enabled:[box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-primary),0_0_0_var(--focus-ring-active-width)_var(--ring-primary-offset-inner),0_0_0_var(--focus-ring-inner-width)_var(--ring-primary-offset-outer)] disabled:bg-$bg-solid-disabled disabled:[box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-primary)] disabled:color-$color-disabled',
  ],
  ...
  [
    'v-accent-solid',
    'bg-$bg-accent border-transparent color-$color-on-accent [box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-accent)] hover:enabled:[box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-accent),0_0_0_var(--focus-ring-inner-width)_var(--ring-accent-offset-inner),0_0_0_var(--focus-ring-outer-width)_var(--ring-accent-offset-outer)] focus-visible:[box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-accent),0_0_0_var(--focus-ring-inner-width)_var(--ring-accent-offset-inner),0_0_0_var(--focus-ring-outer-width)_var(--ring-accent-offset-outer)] active:enabled:translate-y-[1px] active:enabled:[box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-accent),0_0_0_var(--focus-ring-active-width)_var(--ring-accent-offset-inner),0_0_0_var(--focus-ring-inner-width)_var(--ring-accent-offset-outer)] disabled:[box-shadow:inset_0_0_0_var(--focus-ring-inner-width)_var(--border-accent-disabled)] disabled:bg-$border-accent-disabled disabled:color-$color-accent-solid-disabled',
  ],

  [
    'v-accent-outline',
    'relative isolate overflow-hidden bg-transparent border-transparent color-$color-accent transform-gpu [transition-property:color,box-shadow] [transition-duration:var(--motion-secondary-sweep-duration)] [transition-timing-function:var(--motion-secondary-sweep-ease)] [box-shadow:inset_0_0_0_2px_var(--border-accent)] before:content-[\'\'] before:absolute before:inset-0 before:rounded-[inherit] before:bg-$bg-accent-outline-fill before:translate-y-full before:[transition:transform_var(--motion-secondary-sweep-duration)_var(--motion-secondary-sweep-ease)] before:z-0 hover:enabled:before:translate-y-0 hover:enabled:color-$color-primary hover:enabled:[box-shadow:inset_0_0_0_2px_var(--border-accent-outline-fill)] active:enabled:translate-y-[1px] active:enabled:before:translate-y-0 active:enabled:color-$color-primary active:enabled:[box-shadow:inset_0_0_0_2px_var(--border-accent-outline-fill)] focus-visible:before:translate-y-0 focus-visible:color-$color-primary focus-visible:[box-shadow:0_0_0_2px_var(--ring-accent-offset-inner),0_0_0_4px_var(--border-accent-outline-fill)] disabled:before:translate-y-full disabled:[box-shadow:inset_0_0_0_2px_var(--border-accent-disabled)] disabled:color-$color-accent-outline-disabled',
  ],
