...
// TODO: Move all props in a separate file
...
const containerRef = ref<HTMLElement | string | null>('containerRef')
const canvasRef = ref<HTMLCanvasElement | string | null>('canvasRef')
